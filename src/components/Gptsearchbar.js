...
<form className="w-[50%] mx-auto py-44 " onSubmit={(e)=>e.preventDefault()}>   
    <div className="relative">
      ...
      <input className="block w-full p-4 ps-10  border border-gray-300 rounded-lg  focus:ring-red-700 focus:border-red-700 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 text-white " placeholder="Search Movies, TV Shows..." required ref={searchdata} />
      <button  className="text-white absolute end-2.5 bottom-2.5  focus:ring-2  rounded-lg  px-4 py-2 dark:bg-red-700 hover:bg-red-500" onClick={handlegpt}>Search</button>
    </div>
